...
function PostCode() {
  ...
  var post_req = http.request(post_options, function(res) {
      ...
      res.on('end',function(){
      var resBodyObj = querystring.parse(body);
              ...
              if (Wrows.length != 0)
              {
                for (var i = 0 ; i < Wrows.length ; i++)
                 {   
                    ...
                    console.log(Wrows[i].watthour);
                    console.log(Wrows[i].currentwatt);
                    var watt=(number)resBodyObj.watt;
                    var wattHour=(number)resBodyObj.watthour;
                    var wattLimit=(number)Wrows[i].currentwatt;
                    var wattHourLimit=(number)Wrows[i].watthour;
